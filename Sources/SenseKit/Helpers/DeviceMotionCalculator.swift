...
/// `DeviceMotionCalculator` is a utility class for processing motion data from a `CMDeviceMotion` instance.
...
///
/// - Singleton: Access the shared instance via `DeviceMotionCalculator.shared`.
